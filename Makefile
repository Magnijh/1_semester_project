denDigitaleMadplan.exe: Madspild.c scanData.o menu.o readData.o fileNames.o printFunctions.o calculations.o changeDir.o
	gcc Madspild.c scanData.o menu.o readData.o fileNames.o printFunctions.o calculations.o changeDir.o -ansi -Wall -pedantic -o denDigitaleMadplan.exe
